...
import type { SabrStream } from 'googlevideo/sabr-stream';
...
interface TrackBuffer {
  ...
  /** The underlying SabrStream, used to abort the download on eviction. */
 ...
 */
function getOrStartTrack(videoId: string, options: SabrPlaybackOptions): TrackBuffer {
